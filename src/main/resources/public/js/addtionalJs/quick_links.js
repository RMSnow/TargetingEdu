    ...
    var
        ...
        quickDataFns = {
            ...
            message_list: {
                ...
                '<span class="ibar_cart_group_title"></span>' +
                '</div><ul><li class="cart_item"><div class="cart_item_pic">' +
                '</div><div class="cart_item_desc">' +
                '<a  class="cart_item_name">选择题： </a>' +
                '<a  class="cart_item_name">填空题： </a>' +
                '<a  class="cart_item_name">解答题： </a>' +

                '<div class="cart_item_sku"><span> </span></div><div class="cart_item_price"><span class="cart_price"></span></div></div>	</li></ul></div><div class="cart_handler"><div class="cart_handler_header"><span class="cart_handler_left"><span class="cart_price"></span></span><span class="cart_handler_right">￥569.00</span></div><a href="#" class="cart_go_btn" target="_blank">预览试卷</a></div></div>',
                init: $.noop
            },
