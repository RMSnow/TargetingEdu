...
* [#12097](http://dev.ckeditor.com/ticket/12097): Fixed: JAWS not reading the ordinal of options correctly in the [Text Color and Background Color](http://ckeditor.com/addon/colorbutton) button menu.
